    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSalvarConfig.setOnClickListener(v -> {
            ...
            if(!editTextEquipConfig.getText().toString().equals("") &&
                ...
                LogProcessoDAO.getInstance().insertLogProcesso("pomContext.getConfigCTR().verEquipConfig(" + editTextEquipConfig.getText().toString() + ", ConfigActivity.this ,TelaInicialActivity.class, progressBar);", getLocalClassName());
                pomContext.getConfigCTR().verEquipConfig(editTextSenhaConfig.getText().toString(), BuildConfig.VERSION_NAME, editTextEquipConfig.getText().toString(), ConfigActivity.this , TelaInicialActivity.class, progressBar, getLocalClassName(), 2);
